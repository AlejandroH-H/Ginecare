...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark text-light bg-dark px-2">
        ...
        <li class="nav-item active">
          <a class="linkSalir" href="admin_citas.php">Revisar Citas Por Confirmar (<?php echo $conta ?>) </a>
        </li>
    ...
    <table class="tabla">
      <thead>
        <tr>
          ...
          <th scope="col" class="columnas columTitulo">Desconfirmar o Eliminar</th>
          <th scope="col" class="columnas columTitulo">Posponer</th>
        </tr>
      </thead>
      <tbody>

        <?php require("../../model/adminCitas/adminCitasConsultaConfirm.php"); ?>
